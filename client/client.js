		...
		function Explorer(props) {
			...
			return React.createElement('div', { className: 'fdt-panel' },
				...
				React.createElement('div', { className: 'fdt-body' },
					...
					s.treeCollapsed ? null : React.createElement('div', { className: 'fdt-tree' },
